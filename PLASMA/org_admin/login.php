...
<body background="org_img\blood-cells.jpg" >
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      <div class="row justify-content-center">
          <div class="col-lg-6">
              <h1 class="mt-4 mb-3" style="color:#00d6d6 ;">
      ...
      <div class="card" style="height:250px; background-image:url('org_img/glossy1.jpg');">
          <div class="card-body">
...
<br>
  ...
  if(isset($_POST["login"])){
    ...
    $sql="SELECT * from org_admin_info where org_admin_username='$username' and org_admin_password='$password'";
