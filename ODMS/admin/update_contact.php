  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <?php if(isset($_POST['update']))
      {
        ...
        $number=$_POST['organs'];
        $organs=$_POST['contactno'];
        $conn=mysqli_connect("localhost","root","","blood_donation") or die("Connection error");
        $sql= "update contact_info set contact_address='{$address}', organs='{$organs}', contact_phone='{$number}' where contact_id='1'";
      ...
      <div class="form-group">
                ...
                <div class="form-group">
                  <label class="col-sm-4 control-label"> Organs</label>
                  <div class="col-sm-8">
                    <input type="organs" class="form-control" name="organs" id="organs" value="" required>
                  </div>
                </div>
      <div class="form-group">
