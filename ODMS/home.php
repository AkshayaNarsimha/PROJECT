...
<br>
        <h1 style="text-align:center;font-size:45px;">Welcome to Organ Donor Management System</h1>
<br>
        <div class="row">
            <div class="col-lg-6 mb-4">
                <div class="card">
                    <h4 class="card-header card bg-info text-white" >Who can Donate!</h4>
        ...
        <div class="row mb-4">
            <div class="col-md-8">
            <h4>BASIC INFORMATION TO KNOW BEFORE DONATING ORGANS</h4>
            <p>
              <?php
                include 'conn.php';
            ...
            <div class="col-md-4">
                <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" style="align:center; background-color:#BAFEA3;color:#000000 ">Become a Donor </a>
            </div>
        </div>
